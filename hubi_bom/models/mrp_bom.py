...
class MrpBom(models.Model):
    ...
    def explode(self, product, quantity, picking_type=False):
        ...
        while bom_lines:
            ...
            bom = self._bom_find(product=current_line.product_id, company_id=self.company_id.id, bom_type='phantom')
...
class MrpBomLine(models.Model):
    ...
    def action_see_attachments(self):
        ...
        attachment_view = self.env.ref('hubi_bom.view_document_file_kanban_mrp')
        return {
            'name': _('Attachments'),
            'domain': domain,
